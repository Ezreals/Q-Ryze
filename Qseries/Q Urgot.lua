...
local ts = TargetSelector(TARGET_LOW_HP_PRIORITY, 1250)
local ignite = nil
local version = "1.000"
local Author = "qkwlqk"
local Date = "5/11"
...
function Menu()
  Menu = scriptConfig("QUrgot", "Q Urgot")
...
function SpellData()
HPred:AddSpell("Q", 'Urgot', {collisionM = true, collisionH = true, delay = .50, range = 1000, speed = 1600, type = "DelayLine", width = 80})
HPred:AddSpell("E", 'Urgot', {collisionM = true, collisionH = true, delay = .50, range = 950, speed = 1750, type = "DelayCircle", width = 300})
end
